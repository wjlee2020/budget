...
export const addEntryRedux = (id) => {
    return {
        type: types.ADD_ENTRY, payload = { id }
    }
};

export const removeEntryRedux = id => {
    return {
        type: types.REMOVE_ENTRY, payload: { id }
    }
};
...
export const populateEntries = entries => {
    return {
        type: types.POPULATE_ENTRIES, payload: { entries }
    }
};

export const populateEntryDetails = (id, entry) => {
    return {
        type: types.POPULATE_ENTRY_DETAILS, payload: { id, entry }
    }
};
